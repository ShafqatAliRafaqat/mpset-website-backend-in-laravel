...
<!-- Area Chart Example-->
    ...
    <div class="widget-box">
      ...
      <h5>Displaying List of All Completed Events</h5>
      ...
      <table class="table table-bordered table-striped data-table dataTable" id="DataTables_Table_10">
            ...
            <tr class="gradeX text-center">
                    ...
                    <td>$29321</td>
                    <td > <a title="View Event Detail" href="details/{{ $event->id }}"><span class="color-dark icon-list" aria-hidden="true"></span></a> </td>
                    <td>
                        <a title="Edit User" href="edit/{{ $event->id }}"><span class="color-dark-s icon-edit" aria-hidden="true"></span></a>
                        <a title="Delete User" href="delete/{{ $event->id }}"><span class="color-dark-s icon-trash" aria-hidden="true"></span></a>
                    </td>
                </tr>
            @endforeach
            @endif
